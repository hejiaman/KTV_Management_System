...
public class changewaipsw extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					changewaipsw frame = new changewaipsw();
...
//		currentuserLabel.setEnabled(false);
	...
	protected void submit(ActionEvent e) {
		...
		JOptionPane.showMessageDialog(this, waiterdao.editpassword(oldPassword, newPassword, id));
	}
